...
public class ReferenceFactoryTest {
	...
	public void testEntityReference() throws URISyntaxException {
		...
		URI uri = ReferenceFactory.newReference(getCustomizableSampleEntity());
		assertNotNull(uri);
		assertEquals("urn:dowsers:identity#4c8b03dd-908a-4cad-8d48-3c7277d44ac9", uri.toString());

		uri = ReferenceFactory.newReference(getCustomizableSampleEntity(), "name");
		assertNotNull(uri);
		assertEquals("urn:dowsers:name#4c8b03dd-908a-4cad-8d48-3c7277d44ac9", uri.toString());
	}
