...
//	}
	...
	// TODO how manage ClassCastException
	@Override
	public <T> void setProperty(String name, T value) throws NullPointerException, IllegalArgumentException, ClassCastException {
		Preconditions.checkArgument(!"".equals(Preconditions.checkNotNull(name)));
