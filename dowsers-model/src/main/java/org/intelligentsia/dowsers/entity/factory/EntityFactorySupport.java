...
/**
 * EntityFactorySupport implements {@link EntityFactory} to easy instantiation
 * of {@link Entity}.
 * 
 ...
 * @param <T>
 */
public abstract class EntityFactorySupport implements EntityFactory {
	...
	/**
	 * Build a new instance of EntityFactorySupport.java.
	 * 
	 * @param metaEntityContextRepository
	 * @throws NullPointerException
	 *             if metaEntityContextRepository is null
	 */
	public EntityFactorySupport(final MetaEntityContextRepository metaEntityContextRepository) throws NullPointerException {
		super();
