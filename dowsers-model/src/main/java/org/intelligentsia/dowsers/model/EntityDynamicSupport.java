...
public class EntityDynamicSupport extends EntitySupport {
	 ...
	 */
	public EntityDynamicSupport(String identity, MetaEntityContext metaEntityContext) throws NullPointerException {
	 ...
	 */
	public EntityDynamicSupport(String identity, MetaEntityContext metaEntityContext, Map<String, Object> attributes) throws NullPointerException {
		super(identity, metaEntityContext);
