...
/**
 * BaseEntityFactorySupport implements {@link EntityFactory} for
 * {@link BaseEntity}.
 * 
 * @author <a href="mailto:jguibert@intelligents-ia.com" >Jerome Guibert</a>
 */
public class BaseEntityFactorySupport extends AbstractEntityFactorySupport {

	/**
	 * Build a new instance of BaseEntityFactorySupport.java ( @see
	 * {@link AbstractEntityFactorySupport} )
	 * 
	 * @param metaEntityContextRepository
	 * @throws NullPointerException
	 */
	public BaseEntityFactorySupport(final MetaEntityContextRepository metaEntityContextRepository) throws NullPointerException {
