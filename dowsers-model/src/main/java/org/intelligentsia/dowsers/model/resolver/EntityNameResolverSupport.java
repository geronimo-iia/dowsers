 ...
 * 
 */
public abstract class EntityNameResolverSupport implements EntityNameResolver {
	 ...
	 * Build a new instance of EntityNameResolverSupport.java.
	 */
	public EntityNameResolverSupport(EntityNameResolver next) {
		this.next = next;
	}

	/**
	 * @return next {@link EntityNameResolver} instance or null if no successor.
	 */
	public EntityNameResolver next() {
		return next;
	}

	public void setNext(EntityNameResolver next) {
		this.next = next;
	}
