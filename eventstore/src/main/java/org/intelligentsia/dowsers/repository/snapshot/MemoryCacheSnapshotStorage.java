...
public class MemoryCacheSnapshotStorage implements SnapShotStorage {
	...
	/**
	 * @see org.intelligentsia.dowsers.repository.snapshot.SnapShotStorage#findLatestSnapShot(java.util.UUID)
	 */
	@Override
	...
	/**
	 * @see org.intelligentsia.dowsers.repository.snapshot.SnapShotStorage#store(org.intelligentsia.dowsers.repository.snapshot.SnapShot)
	 */
	@Override
